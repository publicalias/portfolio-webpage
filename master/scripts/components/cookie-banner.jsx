...
const CookieBanner = () => !storageKey("consent") && (
  <div className="c-content--xl c-cookie-banner js-hide-banner">
    <p className="c-cookie-banner__text">This site uses cookies primarily to facilitate user authentication. By continuing to use this site, you consent to its use of cookies.</p>
